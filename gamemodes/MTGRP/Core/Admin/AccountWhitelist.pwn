...
TO RE-ENABLE:
1. RE ENABLE stock IsAccountApproved(name[])
2. in vortexrp, 
//ShowPlayerDialog(playerid, DIALOG_CREATION_PIN, DIALOG_STYLE_INPUT, "Creation Pin", "Please enter the creation pin given to you by an admin.", "Enter", "Cancel");
				...
				Delete bottom line, enable top line
3.
...
#define ACCOUNT_CREATION_STRING	"*** Your account is not approved for creation. Please visit {FF1EBB}\'https://crearoleplay.com\' {F6970C}***"
