...
stock GetMaterialsForParty(partyid, mattype, skipid)
{
	foreach(Player, i)
	{
		...
		SendClientMessage(i, ORANGE, "Tip: The checkpoints will POINT you towards your materials, you need to go to the area where the all checkpoint arrows POINT to.");
